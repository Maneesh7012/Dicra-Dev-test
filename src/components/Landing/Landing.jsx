  ...
  return (
    <React.Fragment>
      <div>
        ...
        >
          <p style={{ fontSize: "26px", paddingBottom: "0px", fontWeight: "700", display: "flex", color: "#FFFFFF" }}>DiCRA</p>
          <p style={{ fontSize: "18px", fontWeight: "400", lineHeight: "44px" }}>
          ...
          <p style={{ fontSize: "26px", paddingBottom: "0px", fontWeight: "700" }}>
            Select State
          </p>
          <div>
            <ul class="cards">
