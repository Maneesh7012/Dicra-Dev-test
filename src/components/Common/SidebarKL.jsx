  ...
  return (
    <div className="container-sidebar">
      ...
      >
        ...
        <NavLink
          style={
            Showdownload
              ? { background: "#143461" }
              : Showlayer
                ? { background: "#0B202F", borderRadius: "12px" }
                : { background: "#143461" }
          }
          to={"/kerala"}
          key={1}
        ...
        {Showlayer && (
          <div className="layer-container">
            ...
            >
              <div className="layer-content" style={{
                padding: "10px",
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      id="socio-eco"
                      name="radiolayer"
                      onClick={() => setselectedCategory("SOCIO-ECONOMIC")}
                      defaultChecked
                    />
                    ...
                    <input type="radio" id="env" name="radiolayer" onClick={() => setselectedCategory("ENVIRONMENTAL")} />
                    ...
                    <input type="radio" id="infra" name="radiolayer" onClick={() => setselectedCategory("INFRASTRUCTURE")} />
                    ...
                    <input type="radio" id="dppd" name="radiolayer" onClick={() => setselectedCategory("POSITIVE DEVIANCE & NEGATIVE DEVIANCE")} />
                ...
                <div>
                  {allLayers[selectedCategory].map((item) => {
                    return (<FormGroup check>
                      <Row style={{ padding: "10px" }}>
                        ...
                        <Col md={5}>
                          <img src={Show} alt="" width="19px" style={{ marginLeft: "10px", cursor: "pointer" }} data-tooltip-id="show-tooltip" data-tooltip-content="Show/hide" />
                          <Tooltip id="show-tooltip" />
                          <img src={Download} alt="" width="13px" style={{ marginLeft: "10px", cursor: "pointer" }} data-tooltip-id="download-tooltip" data-tooltip-content="Download" onClick={() => setShowdownload(!Showdownload)} />
                          <Tooltip id="download-tooltip" />
                          <img src={About} alt="" width="18px" style={{ marginLeft: "10px", cursor: "pointer" }} data-tooltip-id="about-tooltip" data-tooltip-content="Normalized Difference Vegetation Index" />
      ...
      <main>
        ...
        <div 
        className="legend" style={{ marginLeft:isCollapse ? "30px" : Showdownload ? "350px" : Showlayer ? "350px": "30px"}}
        >
          <div className="legend-layer-name">Layer Name</div>
          <div className="legend-layer-value">0.02</div>
          <div className="legend-layer-date">01-01-2021</div>
          <div className="legend-layer-latlong">17.77,78.46 <img src={Nav} width="19px"/></div>
          <div>
          <ColorPicker />
          </div>
        </div>
