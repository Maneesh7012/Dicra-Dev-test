...
const SidebarJH = ({ children }) => {
  ...
  const [LayerName, setLayerName] = useState("NDVI");
  const [LayerDate, setLayerDate] = useState("19-02-2023");
  const toggleClass = () => {
  ...
  const onChangeLayer = (layer) => {
    ...
    if (layer == "NDVI") {
      history("/jharkhand");
      setLayerDate("19-02-2023")
    } else if (layer == "LAI") {
      history("/map-lai");
      setLayerDate("27-02-2023")
    } else if (layer == "SM") {
      history("/map-ssm");
      setLayerDate("02-08-2022")
    } else if (layer == "LST") {
      history("/map-lst");
      setLayerDate("01-02-2023")
    }
  };
  return (
          ...
          <div className="layer-container">
            ...
            >
              ...
              >
                ...
                <div>
                  {selectedCategory === "SOCIO-ECONOMIC" ? (
                    <div>
                      {" "}
                      <FormGroup check>
                        <Row style={{ padding: "10px" }}>
                          <Col md={7}>
                            <Input
                              ...
                              type="radio"
                              value="NDVI"
                              checked={LayerName == "NDVI" ? true : false}
                              onChange={(e) => {
                                onChangeLayer("NDVI");
                              }}
                            />{" "}
                          ...
                          <Col md={5} >
                            ...
                            <img
                              ...
                              data-tooltip-content="Normalized Difference Vegetation Index"
                            />
                        ...
                        <Row style={{ padding: "10px" }}>
                          <Col md={7}>
                            <Input
                              ...
                              type="radio"
                              value="LAI"
                              checked={LayerName == "LAI" ? true : false}
                              onChange={(e) => {
                                onChangeLayer("LAI");
                              }}
                            />{" "}
                            <Label check>Leaf Area Index</Label>
                          </Col>
                          <Col md={5}>
                            <img
                              src={Show}
                            ...
                            <img
                              ...
                              style={{ marginLeft: "10px", cursor: "pointer" }}
                              data-tooltip-id="about-tooltip"
                              data-tooltip-content="Leaf Area Index"
                            />
                            <Tooltip id="about-tooltip" />
                          </Col>
                        </Row>
                        ...
                        <Row style={{ padding: "10px" }}>
                          <Col md={7}>
                            <Input
                              ...
                              type="radio"
                              value="SSM"
                              checked={LayerName == "SM" ? true : false}
                              onChange={(e) => {
                                onChangeLayer("SM");
                              }}
                            />{" "}
                            <Label check>Soil Moisture</Label>
                          </Col>
                          <Col md={5}>
                            <img
                              src={Show}
                            ...
                            <img
                              ...
                              style={{ marginLeft: "10px", cursor: "pointer" }}
                              data-tooltip-id="about-tooltip"
                              data-tooltip-content="Soil Moisture"
                            />
                            <Tooltip id="about-tooltip" />
                          </Col>
                        </Row>
                        ...
                        <Row style={{ padding: "10px" }}>
                          <Col md={7}>
                            <Input
                              ...
                              type="radio"
                              value="LST"
                              checked={LayerName == "LST" ? true : false}
                              onChange={(e) => {
                                onChangeLayer("LST");
                              }}
                            />{" "}
                            <Label check>Land Surface Temperature (LST)</Label>
                          </Col>
                          <Col md={5}>
                            <img
                              src={Show}
                            ...
                            <img
                              ...
                              style={{ marginLeft: "10px", cursor: "pointer" }}
                              data-tooltip-id="about-tooltip"
                              data-tooltip-content="Land Surface Temperature"
                            />
                            <Tooltip id="about-tooltip" />
                          </Col>
                        </Row>
 ...
 setShowdownload(false); */}
      <main>
        <span style={{ display: isLegendshow ? "block" : "none" }}>
          ...
          >
            <div className="legend-layer-name">{LayerName}</div>
            <div className="legend-layer-value">0.02</div>
            <div className="legend-layer-date">{LayerDate}</div>
            <div className="legend-layer-latlong">
              17.77,78.46 <img src={Nav} width="19px" />
            </div>
            <div>
              <ColorPicker />
            </div>
